...
<div align="center" style="max-width: 800px; margin: auto;">
  <div align="left" style="background-color: #1A1B26; padding: 8px 15px; border-radius: 10px 10px 0 0; border: 1px solid #30363D; border-bottom: none; display: flex; align-items: center;">
    <img src="https://img.shields.io/badge/bash_--_system.bio-1A1B26?style=flat-square&logo=gnu-bash&logoColor=7AA2F7" alt="Bash Terminal"/>
  </div>
...
<div align="center">
  <details style="background-color: #0D1117; border: 1px solid #30363D; border-radius: 8px; padding: 15px; margin-bottom: 15px; width: 80%; cursor: pointer; box-shadow: 0 4px 10px rgba(0,0,0,0.3);">
    <summary style="font-family: 'Fira Code', monospace; color: #FF9E64; font-size: 18px; font-weight: bold;">
      ▶ 📁 /root/core_languages.sh
    </summary>
    <br>
    <picture>
  ...
  <details style="background-color: #0D1117; border: 1px solid #30363D; border-radius: 8px; padding: 15px; margin-bottom: 15px; width: 80%; cursor: pointer; box-shadow: 0 4px 10px rgba(0,0,0,0.3);">
    <summary style="font-family: 'Fira Code', monospace; color: #7AA2F7; font-size: 18px; font-weight: bold;">
      ▶ 📁 /root/arsenal_tecnologico_completo.dll
    </summary>
    <br>
    <picture>
...
<h2 align="center">🕹️ Atividade do Sistema (Live Data)</h2>
<div align="center" style="background-color: #0D1117; border: 1px solid #30363D; border-radius: 10px; padding: 10px; box-shadow: 0 0 20px rgba(122, 162, 247, 0.1);">
...
<h2 align="center">🚀 Deployments & Projetos em Destaque</h2>

<table align="center" width="100%" style="border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td align="center" width="50%" style="border: 1px solid #30363D; padding: 20px; background-color: #0D1117; border-radius: 10px;" valign="top">
      ...
      <p style="color: #C9D1D9; font-weight: bold; font-size: 16px;">Interface Principal & Dashboard</p>
      <td>
      <details style="text-align: left; background-color: #1A1B26; padding: 10px; border-radius: 5px; border: 1px solid #30363D; cursor: pointer;">
        <summary style="color: #7AA2F7; font-weight: bold; font-family: monospace;">[+] Ver Especificações Técnicas</summary>
        <p style="color: #8B949E; font-size: 13px; margin-top: 10px;">
          > Integração de dados em tempo real.<br>
          > Interface reativa baseada no ecosistema JS.<br>
          > Conexão nativa com fluxos de automação.
        </p>
      </details>
    </td>
    <td>
    <td align="center" width="50%" style="border: 1px solid #30363D; padding: 20px; background-color: #0D1117; border-radius: 10px;" valign="top">
      ...
      <p style="color: #C9D1D9; font-weight: bold; font-size: 16px;">Documentação e Arquivos</p>
      <details style="text-align: left; background-color: #1A1B26; padding: 10px; border-radius: 5px; border: 1px solid #30363D; cursor: pointer;">
        <summary style="color: #7AA2F7; font-weight: bold; font-family: monospace;">[+] Ver Especificações Técnicas</summary>
        <p style="color: #8B949E; font-size: 13px; margin-top: 10px;">
          > Repositório estruturado de scripts RPA.<br>
          > Modelagem de documentação de código.<br>
          > Arquitetura limpa para manutenção.
        </p>
      </details>
    </td>
  </tr>
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=100&section=footer&customColorList=0D1117,1A1B26,58A6FF" width="100%"/>
</div>

<div align="center" style="margin-top: -30px;">
  <a href="https://github.com/itorresxp">
    <img src="https://komarev.com/ghpvc/?username=itorresxp&label=CONEX%C3%95ES+SEGURAS+ESTABELECIDAS&color=58A6FF&style=for-the-badge&base=100" alt="Visitor Counter" />
  </a>
</div>
